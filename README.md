...
As aulas são no-code/low-code, com ferramentas e temas incluindo:

- **N8N** (foco principal), Make e Zapier
- Integração de **Inteligência Artificial** em fluxos de automação (ChatGPT/OpenAI)
- **Claude (Anthropic)** — atualmente ensinando como usar a IA da Anthropic em fluxos de automação e assistentes
- WhatsApp Business API, Telegram, Slack, Notion
- Google Sheets e PostgreSQL como fontes/destinos de dados
- Automação de pré-vendas, cobrança, contratos e onboarding

As aulas se adaptam ao nível do aluno (iniciante ou avançado) e a projetos reais que o aluno já tenha em mente.
...
- [React Hook Form](https://react-hook-form.com/) + [Zod](https://zod.dev/) para o formulário de contato
